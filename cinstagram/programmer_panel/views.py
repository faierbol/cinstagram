...
def programmer_panel_signup():
    ...
    return render_template("programmer_panel/programmer_panel_signup.html", data=data)
...
def programmer_panel_login():
    ...
    data = {"invalid_credentials": invalid_credentials}
    return render_template("programmer_panel/programmer_panel_login.html", data=data)
...
def programmer_panel_index():
    ...
    return render_template("programmer_panel/programmer_panel_index.html", data=data)
